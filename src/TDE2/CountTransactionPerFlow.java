...
public class CountTransactionPerFlow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path output = new Path("output/Question4TDE.txt");

        Job job = Job.getInstance(conf, "TransactionByFlow");

        job.setJarByClass(CountTransactionPerFlow.class);
        ...
        if (job.waitForCompletion(true)) {
            ...
            Path outputFile = new Path("output/Question4TDETEXT.txt");
