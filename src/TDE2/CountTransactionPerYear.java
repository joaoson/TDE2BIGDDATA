...
public class CountTransactionPerYear {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path output = new Path("output/Question2TDE.txt");

        Job job = Job.getInstance(conf, "TransactionByYear");

        job.setJarByClass(CountTransactionPerYear.class);
        job.setMapperClass(CountTransactionYearMapper.class);
        job.setCombinerClass(CountTransactionYearReducer.class);
        ...
        if (job.waitForCompletion(true)) {
            ...
            Path outputFile = new Path("output/Question2TDETEXT.txt");
