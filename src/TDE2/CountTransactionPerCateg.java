...
public class CountTransactionPerCateg {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path output = new Path("output/Question3TDE.txt");

        Job job = Job.getInstance(conf, "TransactionByCateg");

        job.setJarByClass(CountTransactionPerCateg.class);
        ...
        if (job.waitForCompletion(true)) {
            ...
            Path outputFile = new Path("output/Question3TDE.txt");
